...
create table atuacoes (
	...
	constraint fk_atuacoes_engenheiros 
		foreign key (engenheiro_id) references engenheiros (crea),
...
alter table projetos
	add column projeto_filho int null,
	add constraint fk_projetos_projeto_filho
		foreign key (projeto_filho)
			references projetos (id);
